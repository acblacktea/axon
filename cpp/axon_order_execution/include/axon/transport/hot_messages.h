...
AXON_ASSERT_HOT_POD(PlaceOrderMsg);
AXON_ASSERT_HOT_POD(CancelOrderMsg);
AXON_ASSERT_HOT_POD(ModifyOrderMsg);
AXON_ASSERT_HOT_POD(OrderUpdateMsg);
AXON_ASSERT_HOT_POD(FillMsg);
AXON_ASSERT_HOT_POD(HeartbeatMsg);

#undef AXON_ASSERT_HOT_POD
