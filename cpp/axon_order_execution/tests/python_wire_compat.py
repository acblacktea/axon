...
note at the top of include/axon/transport/wire.h.
"""
...
def load_python_types(project_root: str) -> dict[str, Any]:
    ...
    try:
        ...
        from axon_order_execution.models.messages import Command, Event, Response
        ...
        from axon_order_execution.transport import serialization
