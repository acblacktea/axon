...
#
# Enable with -DAXON_BENCH_JSON_LIBS=ON.

include(FetchContent)

set(AXON_RAPIDJSON_REF "master")
...
FetchContent_Declare(rapidjson
  URL "https://github.com/Tencent/rapidjson/archive/refs/heads/${AXON_RAPIDJSON_REF}.tar.gz"
  DOWNLOAD_EXTRACT_TIMESTAMP TRUE
  SOURCE_SUBDIR does-not-exist
)
FetchContent_MakeAvailable(rapidjson)

add_library(axon_rapidjson INTERFACE)
# SYSTEM so its own warnings do not trip -Werror in our build.
target_include_directories(axon_rapidjson SYSTEM INTERFACE
  "${rapidjson_SOURCE_DIR}/include")
target_compile_definitions(axon_rapidjson INTERFACE
...
add_library(axon_simdjson STATIC "${_simdjson_dir}/simdjson.cpp")
target_include_directories(axon_simdjson SYSTEM PUBLIC "${_simdjson_dir}")
...
set_target_properties(axon_simdjson PROPERTIES CXX_STANDARD 20)
